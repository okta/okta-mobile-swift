...
nonisolated(unsafe) fileprivate var _implementation: any KeychainProtocol = KeychainImpl()
...
public struct Keychain {
    @Synchronized(variable: "_implementation", lock: staticLock)
    internal static var implementation: any KeychainProtocol
