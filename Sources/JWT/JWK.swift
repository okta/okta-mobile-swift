...
fileprivate nonisolated(unsafe) var _validator: any JWKValidator = DefaultJWKValidator()
...
public struct JWK: Codable, Sendable, Equatable, Identifiable, Hashable {
    ...
    nonisolated(unsafe) public static var validator: any JWKValidator {
        get {
            staticLock.withLock {
                _validator
            }
