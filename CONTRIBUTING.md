...
In your browser, navigate to: [https://github.com/okta/okta-mobile-swift](https://github.com/okta/okta-mobile-swift)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-mobile-swift.git
$ cd okta-mobile-swift
$ git remote add upstream https://github.com/okta/okta-mobile-swift.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-mobile-swift](https://github.com/YOUR_ACCOUNT/okta-mobile-swift)
