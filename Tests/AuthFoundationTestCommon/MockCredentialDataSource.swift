...
final class MockCredentialDataSource: CredentialDataSource {
    nonisolated(unsafe) private(set) var credentials: [Credential] = []

    nonisolated(unsafe) weak var delegate: (any CredentialDataSourceDelegate)?
