...
final class MockCredentialCoordinator: CredentialCoordinator {
    nonisolated(unsafe) var credentialDataSource: any CredentialDataSource = MockCredentialDataSource()
    nonisolated(unsafe) var tokenStorage: any TokenStorage = MockTokenStorage()
